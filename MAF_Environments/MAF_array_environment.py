...
class MAF_array_environment(MAF_environment):
    def __init__(self,
        ...
        # Agent start loc
        if start_state_world is not None or start_state_sim is not None:
            # -> Get start state in sim reference frame
            self.start_state = convert_coordinates(
                simulation_origin=self.origin,
                simulation_shape=self.shape,
                world_pos=start_state_world,
                simulation_pos=start_state_sim
            )[-1]
    ...
    # def get_POI_at_pos(self, sim_pos: tuple):
    #     for POI in self.POI_dict.keys():
    #         if self.POI_dict[POI].simulation_pos == sim_pos:
    #             return POI
    #         else:
    #             print("WARNING: !!! No POI at provided sim pos !!!")
    #             return
    #
    ...
    #                 else:
    #                     pass
    #     print("WARNING: !!! POI with Name not found !!!")