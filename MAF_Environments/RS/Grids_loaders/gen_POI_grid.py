...
# Own modules
from MAF_Environments.RS.POIs.POI import POI as POI_class
...
def gen_POI_grid(simulation_origin, simulation_shape):
    ...
    for POI in POI_lst:
        POI_dict[POI[1]] = POI_class(name=POI[1],
                                     POI_class=POI[0],
        ...
        POI_array[POI_dict[POI[1]].simulation_pos[0]][POI_dict[POI[1]].simulation_pos[1]] = 1
    
    POI_array = POI_array.astype(int)
